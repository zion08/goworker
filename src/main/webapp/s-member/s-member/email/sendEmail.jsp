...
<style type="text/css">
	<!--
		td { font_family: "굴림"; font-size: 9px;}
...
<body>
	...
	<form name="form" method="post" >
		<table width="600" border="1" cellspacing="1" cellpadding="0">
			<tr>
				<td width="150">보내는사람 이름(name)</td>
				<td width="457"><input type="text" name="name" size="60"></td>
			</tr>
			<tr>
				<td width="134">보내는사람(from Email)</td>
				<td width="457"><input type="text" name="email" size="60"></td>
			</tr>
			<tr>
				<td>제목(subject)</td>
