...
<%
    ...
    int currentPage = pageNum;
			...
			%>
			<table border="1" width="870" text-align="center" style="table-layout:fixed">

				<tr>
					<th width="120">게시판</th>
					<th width="50">번호</th>
					<th width="300">아이디/제목</th>
					<th width="200">작성일</th>
					<th width="60">해제</th>
				</tr>
				...
				<form action="../member/favorite_out_fav.jsp" method="post">
					<tr>
						...
						<td width="300" style="text-overflow:ellipsis;overflow:hidden;white-space:nowrap;"><a href="/goworker/s-member/s-member_detail.jsp?num=<%=dto.getNum()%>&pageNum=<%=pageNum%>"><%=dto.getId()%></a></td>
						<td width="200"><%=dto.getRegdate()%></td>
...
<section class="section2">
	...
	%>
	<a href="favorite.jsp?pageNum=<%=i%>">[<%=i%>]
	</a>
	<%	
	}
